        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_cooperatives_users_created_by",
                        column: x => x.created_by,
                        principalTable: "users",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_cooperatives_users_reviewed_by",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    cooperative_id = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_cooperative_members", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_cooperative_members_cooperative_id",
                table: "cooperative_members",
                column: "cooperative_id");

            migrationBuilder.CreateIndex(
                name: "IX_cooperatives_created_by",
                table: "cooperatives",
                column: "created_by");

            migrationBuilder.CreateIndex(
                name: "IX_cooperatives_name",
                table: "cooperatives",
                column: "name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_cooperatives_reviewed_by",
                table: "cooperatives",
                column: "reviewed_by");
